...
--VERIFY EQUAL: 0x((((((((((((1152921504606846975) - (1023)) * (((1024: ZMod P).inv))) - (1023)) * (((1024: ZMod P).inv))) - (1023)) * (((1024: ZMod P).inv))) - (1023)) * (((1024: ZMod P).inv))) - (1023)) * (((1024: ZMod P).inv))) - (1023)) * (((1024: ZMod P).inv)) =0x0
--VERIFY EQUAL: 0x((((((1152921504606846976) * (((1024: ZMod P).inv))) * (((1024: ZMod P).inv))) * (((1024: ZMod P).inv))) * (((1024: ZMod P).inv))) * (((1024: ZMod P).inv))) * (((1024: ZMod P).inv)) =0x1
...
def fixed_func_col_0 : ℕ → ZMod P :=
  λ row => match row with
    ...
    | 1023 => 1023
    | _ => 0
def fixed_func_col_2 : ℕ → ZMod P :=
  λ row => match row with
    | _ => 0
def fixed_func : ℕ → ℕ → ZMod P :=
  λ col row => match col with
    | 0 => fixed_func_col_0 row
    | 2 => fixed_func_col_2 row
    | _ => 0
------GATES-------
def gate_0: Prop := ∀ row : ℕ,  c.Selector 2 row * ((c.Advice 0 (row + -1) * 0x1024) * c.Advice 0 (row + 1) - c.Advice 0 (row)) = 0
