...
--Annotation: b
def advice_1_1: Prop := c.Advice 1 1 = c.Advice 2 0
def copy_3: Prop := c.Advice 1 1 = c.Advice 2 0
--Annotation: c
def advice_2_1: Prop := c.Advice 2 1 = (c.Instance 0 1) + (c.Advice 2 0)
--EXITED REGION: next row
--REGION: next row
def selector_0_2: Prop := c.Selector 0 2 = 1
--Annotation: a
def advice_0_2: Prop := c.Advice 0 2 = c.Advice 2 0
def copy_4: Prop := c.Advice 0 2 = c.Advice 2 0
--Annotation: b
def advice_1_2: Prop := c.Advice 1 2 = c.Advice 2 1
def copy_5: Prop := c.Advice 1 2 = c.Advice 2 1
--Annotation: c
def advice_2_2: Prop := c.Advice 2 2 = (c.Advice 2 0) + (c.Advice 2 1)
--EXITED REGION: next row
--REGION: next row
def selector_0_3: Prop := c.Selector 0 3 = 1
--Annotation: a
def advice_0_3: Prop := c.Advice 0 3 = c.Advice 2 1
def copy_6: Prop := c.Advice 0 3 = c.Advice 2 1
--Annotation: b
def advice_1_3: Prop := c.Advice 1 3 = c.Advice 2 2
def copy_7: Prop := c.Advice 1 3 = c.Advice 2 2
--Annotation: c
def advice_2_3: Prop := c.Advice 2 3 = (c.Advice 2 1) + (c.Advice 2 2)
--EXITED REGION: next row
--REGION: next row
def selector_0_4: Prop := c.Selector 0 4 = 1
--Annotation: a
def advice_0_4: Prop := c.Advice 0 4 = c.Advice 2 2
def copy_8: Prop := c.Advice 0 4 = c.Advice 2 2
--Annotation: b
def advice_1_4: Prop := c.Advice 1 4 = c.Advice 2 3
def copy_9: Prop := c.Advice 1 4 = c.Advice 2 3
--Annotation: c
def advice_2_4: Prop := c.Advice 2 4 = (c.Advice 2 2) + (c.Advice 2 3)
--EXITED REGION: next row
--REGION: next row
def selector_0_5: Prop := c.Selector 0 5 = 1
--Annotation: a
def advice_0_5: Prop := c.Advice 0 5 = c.Advice 2 3
def copy_10: Prop := c.Advice 0 5 = c.Advice 2 3
--Annotation: b
def advice_1_5: Prop := c.Advice 1 5 = c.Advice 2 4
def copy_11: Prop := c.Advice 1 5 = c.Advice 2 4
--Annotation: c
def advice_2_5: Prop := c.Advice 2 5 = (c.Advice 2 3) + (c.Advice 2 4)
--EXITED REGION: next row
--REGION: next row
def selector_0_6: Prop := c.Selector 0 6 = 1
--Annotation: a
def advice_0_6: Prop := c.Advice 0 6 = c.Advice 2 4
def copy_12: Prop := c.Advice 0 6 = c.Advice 2 4
--Annotation: b
def advice_1_6: Prop := c.Advice 1 6 = c.Advice 2 5
def copy_13: Prop := c.Advice 1 6 = c.Advice 2 5
--Annotation: c
def advice_2_6: Prop := c.Advice 2 6 = (c.Advice 2 4) + (c.Advice 2 5)
--EXITED REGION: next row
--REGION: next row
def selector_0_7: Prop := c.Selector 0 7 = 1
--Annotation: a
def advice_0_7: Prop := c.Advice 0 7 = c.Advice 2 5
def copy_14: Prop := c.Advice 0 7 = c.Advice 2 5
--Annotation: b
def advice_1_7: Prop := c.Advice 1 7 = c.Advice 2 6
def copy_15: Prop := c.Advice 1 7 = c.Advice 2 6
--Annotation: c
def advice_2_7: Prop := c.Advice 2 7 = (c.Advice 2 5) + (c.Advice 2 6)
--EXITED REGION: next row
