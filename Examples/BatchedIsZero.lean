...
-- Entered region: witness
  ...
  ∧ 0 < c.usable_rows -- Advice 3 assignment
  ∧ 0 < c.usable_rows -- Advice 0 assignment
  ∧ 0 < c.usable_rows -- Advice 1 assignment
  ∧ 0 < c.usable_rows -- Advice 2 assignment
  ∧ 0 < c.usable_rows -- Advice 4 assignment
  ∧ 0 < c.usable_rows -- Advice 5 assignment
...
def gate_0_0_ (c: ValidCircuit P P_Prime) (row: ℕ) : Prop :=
  ((c.get_selector 0 row) * (c.get_advice 4 row)) * ((c.get_advice 4 row) + (-((1)))) = 0
def gate_1_0_ (c: ValidCircuit P P_Prime) (row: ℕ) : Prop :=
  ((c.get_selector 0 row) * (c.get_advice 4 row)) * (c.get_advice 0 row) = 0
def gate_1_1_ (c: ValidCircuit P P_Prime) (row: ℕ) : Prop :=
  ((c.get_selector 0 row) * (c.get_advice 4 row)) * (c.get_advice 1 row) = 0
def gate_1_2_ (c: ValidCircuit P P_Prime) (row: ℕ) : Prop :=
  ((c.get_selector 0 row) * (c.get_advice 4 row)) * (c.get_advice 2 row) = 0
def gate_2_0_ (c: ValidCircuit P P_Prime) (row: ℕ) : Prop :=
  (c.get_selector 0 row) * ((((((1)) + (-(c.get_advice 4 row))) * (((1)) + (-((c.get_advice 0 row) * (c.get_advice 5 row))))) * (((1)) + (-((c.get_advice 1 row) * (c.get_advice 5 row))))) * (((1)) + (-((c.get_advice 2 row) * (c.get_advice 5 row))))) = 0
def gate_3_0_ (c: ValidCircuit P P_Prime) (row: ℕ) : Prop :=
  (c.get_selector 0 row) * ((c.get_advice 4 row) + (-(c.get_advice 3 row))) = 0
