...
namespace Keccak.Soundness
  ...
  lemma chi_os'_2_0 {c: ValidCircuit P P_Prime} (h_meets_constraints: meets_constraints c) (h_round: round ∈ Finset.Icc 1 24) (h_P: 2690186458022863184501052609946142749758152333341729076955<P):
    (os' c round 2 0).val =
  ...
  := by
    ...
    have h_normalize_rho_0 (rot: ℕ) (h_rot: rot ≤ 11) := lookup_col_72 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    have h_normalize_rho_1 (rot: ℕ) (h_rot: rot ≤ 11) := lookup_col_73 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    have h_normalize_rho_2 (rot: ℕ) (h_rot: rot ≤ 11) := lookup_col_74 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    have h_normalize_rho_3 (rot: ℕ) (h_rot: rot ≤ 11) := lookup_col_77 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    have h_normalize_rho_4 (rot: ℕ) (h_rot: rot ≤ 11) := lookup_col_78 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    have h_normalize_rho_5 (rot: ℕ) (h_rot: rot ≤ 11) := lookup_col_79 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    try simp [fin_vals]
    rewrite [
      chi_base_0_2 h_meets_constraints (by simp [keccak_constants]; omega) (by rewrite [Nat.mod_eq_of_lt] <;> omega)
      ...
      chi_base_1_2 h_meets_constraints (by simp [keccak_constants]; omega) (by rewrite [Nat.mod_eq_of_lt] <;> omega)
    ...
    rw [
      ...
      state_3_3_invert h_meets_constraints h_round (by omega),
  ...
  lemma chi_os'_2_1 {c: ValidCircuit P P_Prime} (h_meets_constraints: meets_constraints c) (h_round: round ∈ Finset.Icc 1 24) (h_P: 2690186458022863184501052609946142749758152333341729076955<P):
    (os' c round 2 1).val =
    Normalize.normalize_unpacked (
      rho_s_0_2 c round ^^^ (
  ...
  := by
    ...
    have h_to_cell_manager: 12 * round + 11 < c.n := by omega
    have h_lookup_P: P ≥ 1756 := by omega
    have h_normalize_rho_0 (rot: ℕ) (h_rot: rot ≤ 11) := lookup_col_77 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    have h_normalize_rho_1 (rot: ℕ) (h_rot: rot ≤ 11) := lookup_col_78 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    have h_normalize_rho_2 (rot: ℕ) (h_rot: rot ≤ 11) := lookup_col_79 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    have h_normalize_rho_3 (rot: ℕ) (h_rot: rot ≤ 11) := lookup_col_82 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    have h_normalize_rho_4 (rot: ℕ) (h_rot: rot ≤ 11) := lookup_col_83 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    have h_normalize_rho_5 (rot: ℕ) (h_rot: rot ≤ 11) := lookup_col_84 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    rewrite [
      chi_base_1_2 h_meets_constraints (by simp [keccak_constants]; omega) (by rewrite [Nat.mod_eq_of_lt] <;> omega)
        (h_normalize_rho_0 4 (by trivial)) (h_normalize_rho_1 4 (by trivial)) (h_normalize_rho_2 4 (by trivial)),
      chi_base_1_2 h_meets_constraints (by simp [keccak_constants]; omega) (by rewrite [Nat.mod_eq_of_lt] <;> omega)
      ...
      chi_base_1_2 h_meets_constraints (by simp [keccak_constants]; omega) (by rewrite [Nat.mod_eq_of_lt] <;> omega)
        (h_normalize_rho_0 11 (by trivial)) (h_normalize_rho_1 11 (by trivial)) (h_normalize_rho_2 11 (by trivial)),
      chi_base_2_2 h_meets_constraints (by simp [keccak_constants]; omega) (by rewrite [Nat.mod_eq_of_lt] <;> omega)
        (lookup_zero_rot (h_normalize_rho_3 0 (by trivial))) (lookup_zero_rot (h_normalize_rho_4 0 (by trivial))) (lookup_zero_rot (h_normalize_rho_5 0 (by trivial))),
      chi_base_2_2 h_meets_constraints (by simp [keccak_constants]; omega) (by rewrite [Nat.mod_eq_of_lt] <;> omega)
        (h_normalize_rho_3 1 (by trivial)) (h_normalize_rho_4 1 (by trivial)) (h_normalize_rho_5 1 (by trivial)),
      chi_base_2_2 h_meets_constraints (by simp [keccak_constants]; omega) (by rewrite [Nat.mod_eq_of_lt] <;> omega)
    ...
    rw [
      ...
      state_1_3_invert h_meets_constraints h_round (by omega),
  ...
  lemma chi_os'_2_2 {c: ValidCircuit P P_Prime} (h_meets_constraints: meets_constraints c) (h_round: round ∈ Finset.Icc 1 24) (h_P: 2690186458022863184501052609946142749758152333341729076955<P):
    (os' c round 2 2).val =
    Normalize.normalize_unpacked (
      rho_s_3_2 c round ^^^ (
  ...
  := by
    ...
    have h_to_cell_manager: 12 * round + 11 < c.n := by omega
    have h_lookup_P: P ≥ 1756 := by omega
    have h_normalize_rho_0 (rot: ℕ) (h_rot: rot ≤ 11) := lookup_col_82 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    have h_normalize_rho_1 (rot: ℕ) (h_rot: rot ≤ 11) := lookup_col_83 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    have h_normalize_rho_2 (rot: ℕ) (h_rot: rot ≤ 11) := lookup_col_84 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    have h_normalize_rho_3 (rot: ℕ) (h_rot: rot ≤ 11) := lookup_col_87 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    have h_normalize_rho_4 (rot: ℕ) (h_rot: rot ≤ 11) := lookup_col_88 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    have h_normalize_rho_5 (rot: ℕ) (h_rot: rot ≤ 11) := lookup_col_89 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    rewrite [
      chi_base_2_2 h_meets_constraints (by simp [keccak_constants]; omega) (by rewrite [Nat.mod_eq_of_lt] <;> omega)
        (h_normalize_rho_0 8 (by trivial)) (h_normalize_rho_1 8 (by trivial)) (h_normalize_rho_2 8 (by trivial)),
      chi_base_2_2 h_meets_constraints (by simp [keccak_constants]; omega) (by rewrite [Nat.mod_eq_of_lt] <;> omega)
      ...
      chi_base_2_2 h_meets_constraints (by simp [keccak_constants]; omega) (by rewrite [Nat.mod_eq_of_lt] <;> omega)
        (h_normalize_rho_0 11 (by trivial)) (h_normalize_rho_1 11 (by trivial)) (h_normalize_rho_2 11 (by trivial)),
      chi_base_3_2 h_meets_constraints (by simp [keccak_constants]; omega) (by rewrite [Nat.mod_eq_of_lt] <;> omega)
        (lookup_zero_rot (h_normalize_rho_3 0 (by trivial))) (lookup_zero_rot (h_normalize_rho_4 0 (by trivial))) (lookup_zero_rot (h_normalize_rho_5 0 (by trivial))),
      chi_base_3_2 h_meets_constraints (by simp [keccak_constants]; omega) (by rewrite [Nat.mod_eq_of_lt] <;> omega)
        (h_normalize_rho_3 1 (by trivial)) (h_normalize_rho_4 1 (by trivial)) (h_normalize_rho_5 1 (by trivial)),
      chi_base_3_2 h_meets_constraints (by simp [keccak_constants]; omega) (by rewrite [Nat.mod_eq_of_lt] <;> omega)
    ...
    rw [
      ...
      state_4_3_invert h_meets_constraints h_round (by omega),
  ...
  lemma chi_os'_2_3 {c: ValidCircuit P P_Prime} (h_meets_constraints: meets_constraints c) (h_round: round ∈ Finset.Icc 1 24) (h_P: 2690186458022863184501052609946142749758152333341729076955<P):
    (os' c round 2 3).val =
    Normalize.normalize_unpacked (
      rho_s_1_2 c round ^^^ (
  ...
  := by
    ...
    have h_to_cell_manager: 12 * round + 11 < c.n := by omega
    have h_lookup_P: P ≥ 1756 := by omega
    have h_normalize_rho_0 (rot: ℕ) (h_rot: rot ≤ 11) := lookup_col_92 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    have h_normalize_rho_1 (rot: ℕ) (h_rot: rot ≤ 11) := lookup_col_93 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    have h_normalize_rho_2 (rot: ℕ) (h_rot: rot ≤ 11) := lookup_col_94 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    have h_normalize_rho_3 (rot: ℕ) (h_rot: rot ≤ 11) := lookup_col_97 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    have h_normalize_rho_4 (rot: ℕ) (h_rot: rot ≤ 11) := lookup_col_98 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    have h_normalize_rho_5 (rot: ℕ) (h_rot: rot ≤ 11) := lookup_col_99 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    try simp [fin_vals]
    rewrite [
      chi_base_4_2 h_meets_constraints (by simp [keccak_constants]; omega) (by rewrite [Nat.mod_eq_of_lt] <;> omega)
        (lookup_zero_rot (h_normalize_rho_0 0 (by trivial))) (lookup_zero_rot (h_normalize_rho_1 0 (by trivial))) (lookup_zero_rot (h_normalize_rho_2 0 (by trivial))),
      chi_base_4_2 h_meets_constraints (by simp [keccak_constants]; omega) (by rewrite [Nat.mod_eq_of_lt] <;> omega)
        (h_normalize_rho_0 1 (by trivial)) (h_normalize_rho_1 1 (by trivial)) (h_normalize_rho_2 1 (by trivial)),
      chi_base_4_2 h_meets_constraints (by simp [keccak_constants]; omega) (by rewrite [Nat.mod_eq_of_lt] <;> omega)
      ...
      chi_base_4_2 h_meets_constraints (by simp [keccak_constants]; omega) (by rewrite [Nat.mod_eq_of_lt] <;> omega)
        (h_normalize_rho_0 11 (by trivial)) (h_normalize_rho_1 11 (by trivial)) (h_normalize_rho_2 11 (by trivial)),
      chi_base_5_2 h_meets_constraints (by simp [keccak_constants]; omega) (by rewrite [Nat.mod_eq_of_lt] <;> omega)
        (lookup_zero_rot (h_normalize_rho_3 0 (by trivial))) (lookup_zero_rot (h_normalize_rho_4 0 (by trivial))) (lookup_zero_rot (h_normalize_rho_5 0 (by trivial))),
      chi_base_5_2 h_meets_constraints (by simp [keccak_constants]; omega) (by rewrite [Nat.mod_eq_of_lt] <;> omega)
        (h_normalize_rho_3 1 (by trivial)) (h_normalize_rho_4 1 (by trivial)) (h_normalize_rho_5 1 (by trivial)),
      chi_base_5_2 h_meets_constraints (by simp [keccak_constants]; omega) (by rewrite [Nat.mod_eq_of_lt] <;> omega)
    ...
    rw [
      ...
      state_2_3_invert h_meets_constraints h_round (by omega),
  ...
  lemma chi_os'_2_4 {c: ValidCircuit P P_Prime} (h_meets_constraints: meets_constraints c) (h_round: round ∈ Finset.Icc 1 24) (h_P: 2690186458022863184501052609946142749758152333341729076955<P):
    (os' c round 2 4).val =
    Normalize.normalize_unpacked (
      rho_s_4_2 c round ^^^ (
  ...
  := by
    ...
    have h_to_cell_manager: 12 * round + 11 < c.n := by omega
    have h_lookup_P: P ≥ 1756 := by omega
    have h_normalize_rho_0 (rot: ℕ) (h_rot: rot ≤ 11) := lookup_col_97 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    have h_normalize_rho_1 (rot: ℕ) (h_rot: rot ≤ 11) := lookup_col_98 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    have h_normalize_rho_2 (rot: ℕ) (h_rot: rot ≤ 11) := lookup_col_99 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    have h_normalize_rho_3 (rot: ℕ) (h_rot: rot ≤ 7) := lookup_col_102 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    have h_normalize_rho_4 (rot: ℕ) (h_rot: rot ≤ 7) := lookup_col_103 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    have h_normalize_rho_5 (rot: ℕ) (h_rot: rot ≤ 7) := lookup_col_104 h_meets_constraints h_lookup_P h_to_cell_manager h_round h_rot
    try simp [fin_vals]
    rewrite [
      chi_base_5_2 h_meets_constraints (by simp [keccak_constants]; omega) (by rewrite [Nat.mod_eq_of_lt] <;> omega)
        (h_normalize_rho_0 4 (by trivial)) (h_normalize_rho_1 4 (by trivial)) (h_normalize_rho_2 4 (by trivial)),
      ...
      chi_base_5_2 h_meets_constraints (by simp [keccak_constants]; omega) (by rewrite [Nat.mod_eq_of_lt] <;> omega)
        (h_normalize_rho_0 11 (by trivial)) (h_normalize_rho_1 11 (by trivial)) (h_normalize_rho_2 11 (by trivial)),
      chi_base_6_2 h_meets_constraints (by simp [keccak_constants]; omega) (by rewrite [Nat.mod_eq_of_lt] <;> omega)
        (lookup_zero_rot (h_normalize_rho_3 0 (by trivial))) (lookup_zero_rot (h_normalize_rho_4 0 (by trivial))) (lookup_zero_rot (h_normalize_rho_5 0 (by trivial))),
      chi_base_6_2 h_meets_constraints (by simp [keccak_constants]; omega) (by rewrite [Nat.mod_eq_of_lt] <;> omega)
        (h_normalize_rho_3 1 (by trivial)) (h_normalize_rho_4 1 (by trivial)) (h_normalize_rho_5 1 (by trivial)),
      chi_base_6_2 h_meets_constraints (by simp [keccak_constants]; omega) (by rewrite [Nat.mod_eq_of_lt] <;> omega)
    ...
    rw [
      ...
      state_0_3_invert h_meets_constraints h_round (by omega),
