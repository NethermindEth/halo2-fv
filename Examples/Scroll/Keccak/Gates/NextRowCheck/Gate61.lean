...
namespace Keccak
  ...
  namespace Gates
    ...
    namespace NextRowCheck
      ...
      lemma gate_61_next_row_check (c: ValidCircuit P P_Prime) (h_fixed: c.1.Fixed = fixed_func c) (hgate: gate_61 c) (h_n: 311 < c.n):
        ∀ round ≤ 23,
        iota_s c (round+1) 1 4 = s c (round+2) 1 4
      := by
        unfold gate_61 at hgate
