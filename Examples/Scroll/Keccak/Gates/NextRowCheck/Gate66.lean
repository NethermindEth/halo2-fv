...
namespace Keccak
  ...
  namespace Gates
    ...
    namespace NextRowCheck
      ...
      lemma gate_66_next_row_check (c: ValidCircuit P P_Prime) (h_fixed: c.1.Fixed = fixed_func c) (hgate: gate_66 c) (h_n: 311 < c.n):
        ∀ round ≤ 23,
        iota_s c (round+1) 2 4 = s c (round+2) 2 4
      := by
        unfold gate_66 at hgate
        ...
        have h_next_round: (12 * (round + 1) + 14) % c.n = (12* ((round+1)+1) + 2) % c.n := by
