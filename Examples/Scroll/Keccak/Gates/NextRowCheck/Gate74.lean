...
namespace Keccak
  ...
  namespace Gates
    ...
    namespace NextRowCheck
      ...
      lemma gate_74_next_row_check (c: ValidCircuit P P_Prime) (h_fixed: c.1.Fixed = fixed_func c) (hgate: gate_74 c) (h_n: 311 < c.n):
        ∀ round ≤ 23,
        iota_s c (round+1) 4 2 = s c (round+2) 4 2
      := by
        unfold gate_74 at hgate
