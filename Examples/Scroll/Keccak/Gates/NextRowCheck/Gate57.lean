...
namespace Keccak
  ...
  namespace Gates
    ...
    namespace NextRowCheck
      ...
      lemma gate_57_next_row_check (c: ValidCircuit P P_Prime) (h_fixed: c.1.Fixed = fixed_func c) (hgate: gate_57 c) (h_n: 311 < c.n):
        ∀ round ≤ 23,
        iota_s c (round+1) 1 0 = s c (round+2) 1 0
      := by
        unfold gate_57 at hgate
        ...
        have h_next_round: (12 * (round + 1) + 17) % c.n = (12* ((round+1)+1) + 5) % c.n := by
