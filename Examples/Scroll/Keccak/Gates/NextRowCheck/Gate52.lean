...
namespace Keccak
  ...
  namespace Gates
    ...
    namespace NextRowCheck
      ...
      lemma gate_52_next_row_check (c: ValidCircuit P P_Prime) (h_fixed: c.1.Fixed = fixed_func c) (hgate: gate_52 c) (h_n: 311 < c.n):
        ∀ round ≤ 23,
        iota_s c (round+1) 0 0 = s c (round+2) 0 0
      := by
        unfold gate_52 at hgate
