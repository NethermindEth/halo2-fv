...
namespace Keccak
  ...
  namespace Gates
    ...
    namespace NextRowCheck
      ...
      lemma gate_55_next_row_check (c: ValidCircuit P P_Prime) (h_fixed: c.1.Fixed = fixed_func c) (hgate: gate_55 c) (h_n: 311 < c.n):
        ∀ round ≤ 23,
        iota_s c (round+1) 0 3 = s c (round+2) 0 3
      := by
        unfold gate_55 at hgate
