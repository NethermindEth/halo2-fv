...
namespace Keccak
  ...
  namespace Gates
    ...
    namespace NextRowCheck
      ...
      lemma gate_71_next_row_check (c: ValidCircuit P P_Prime) (h_fixed: c.1.Fixed = fixed_func c) (hgate: gate_71 c) (h_n: 311 < c.n):
        ∀ round ≤ 23,
        iota_s c (round+1) 3 4 = s c (round+2) 3 4
      := by
        unfold gate_71 at hgate
