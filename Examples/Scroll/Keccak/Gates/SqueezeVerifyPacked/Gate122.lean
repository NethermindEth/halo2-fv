...
namespace Keccak
  ...
  namespace Gates
    ...
    namespace SqueezeVerifyPacked
      ...
      lemma gate_122_squeeze_verify_packed (c: ValidCircuit P P_Prime) (h_fixed: c.1.Fixed = fixed_func c) (hgate: gate_122 c) (h_n: 310 < c.n):
        start_new_hash c 300 → hash_words c 25 2 = squeeze_from c 22
      := by
        unfold gate_122 at hgate
        intro h_start
        ...
        norm_num
        have h_n': 264 < c.n := by linarith
        have h_n'': 36 < c.n := by linarith
