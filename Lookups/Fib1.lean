...
def copy_1 (c: ValidCircuit P P_Prime): Prop := c.1.Advice 1 0 = ↑(c.1.Instance 0 1)
def copy_2 (c: ValidCircuit P P_Prime): Prop := c.1.Advice 0 1 = c.1.Advice 1 0
def copy_3 (c: ValidCircuit P P_Prime): Prop := c.1.Advice 1 1 = c.1.Advice 2 0
def copy_4 (c: ValidCircuit P P_Prime): Prop := c.1.Advice 0 2 = c.1.Advice 2 0
def copy_5 (c: ValidCircuit P P_Prime): Prop := c.1.Advice 1 2 = c.1.Advice 2 1
def copy_6 (c: ValidCircuit P P_Prime): Prop := c.1.Advice 0 3 = c.1.Advice 2 1
def copy_7 (c: ValidCircuit P P_Prime): Prop := c.1.Advice 1 3 = c.1.Advice 2 2
def copy_8 (c: ValidCircuit P P_Prime): Prop := c.1.Advice 0 4 = c.1.Advice 2 2
def copy_9 (c: ValidCircuit P P_Prime): Prop := c.1.Advice 1 4 = c.1.Advice 2 3
def copy_10 (c: ValidCircuit P P_Prime): Prop := c.1.Advice 0 5 = c.1.Advice 2 3
def copy_11 (c: ValidCircuit P P_Prime): Prop := c.1.Advice 1 5 = c.1.Advice 2 4
def copy_12 (c: ValidCircuit P P_Prime): Prop := c.1.Advice 0 6 = c.1.Advice 2 4
def copy_13 (c: ValidCircuit P P_Prime): Prop := c.1.Advice 1 6 = c.1.Advice 2 5
def copy_14 (c: ValidCircuit P P_Prime): Prop := c.1.Advice 0 7 = c.1.Advice 2 5
def copy_15 (c: ValidCircuit P P_Prime): Prop := c.1.Advice 1 7 = c.1.Advice 2 6
def copy_16 (c: ValidCircuit P P_Prime): Prop := c.1.Advice 2 7 = ↑(c.1.Instance 0 2)
